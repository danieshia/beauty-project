...
Suggestion: NYX for the closest head-to-head match against CT; Wet n Wild if star rating and price matter more to you than the sentiment number specifically.
